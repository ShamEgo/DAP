...
def create_satellite_figure(lat, lon, height, asset_ref="Selected Location", zoom=17):
    ...
    num_radials = 8  # Number of radial lines
    for i in range(num_radials):
        ...
        fig.add_trace(go.Scattermapbox(
            ...
            name='Radial' if i == 0 else None,  # Show only one legend entry
            showlegend=False,
        ))
...
app.layout = html.Div([
    ...
    html.Div(
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        ...
                        style={
                            'display': 'none', 'width': '100%', 'height': '12vh',
                    ...
                    html.Div(
                        ...
                        style={
                            'width': '100vw', 'min-width': '100vw', 'max-width': '100vw', 'height': '98vh',
                            'padding': '0.5rem', 'margin': '0.2rem'
                        }
                    ),
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                style={
                                    'display': 'none', 'height': '32vh', 'width': '100%', 'overflow': 'auto',
                ...
                style={
                    'display': 'flex', 'flex-direction': 'column', 'width': '45vw', 'min-width': '45vw',
                    'max-width': '35vw', 'height': '98vh', 'margin': '0', 'padding': '0', 'gap': '0.2rem'
                }
            ),
            html.Div(
                    ...
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                style={
                                    'display': 'none', 'width': '100%', 'height': '100vh', 'padding': '0.5rem'
                                }
                            )
                        ],
                        style={
                            'display': 'flex', 'flex-direction': 'column',
                            'width': '35vw', 'height': '98vh', 'padding': '0.5rem', 'gap': '0.2rem'
                        }
                    ),
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                style={
                                    'display': 'none', 'width': '100%', 'height': '49vh',
                        ...
                        style={
                            'display': 'flex', 'flex-direction': 'column',
                            'width': '30vw', 'height': '98vh', 'padding': '0.5rem', 'gap': '0.2rem'
                        }
                    )
                ],
                ...
                style={
                    ...
                    'width': '66.66vw', 'min-width': '66.66vw', 'max-width': '66.66vw', 'height': '100vh',
        ...
        style={
            ...
            'width': '100vw', 'min-height': '98vh',
            'margin': '0', 'padding': '0', 'gap': '0.2rem', 'overflow-x': 'hidden'
        }
    )
], style={'background-color': 'black', 'min-height': '98vh', 'margin': '0', 'padding': '0'})
...
def update_layout(click_info):
    ...
    default_table_style = {
        'display': 'none', 'width': '100%', 'height': '15vh',
        'padding': '0.5rem', 'margin': '0.2rem'
    }
    default_plot_style = {
        'display': 'none', 'width': '100%', 'height': '49vh',
    ...
    default_satellite_style = {
        'display': 'none', 'height': '35vh', 'width': '100%', 'overflow': 'auto',
        'box-sizing': 'border-box', 'background-color': '#1a1a1a', 'border': '2px solid #444',
        'border-radius': '8px', 'margin': '0.2rem'
    }
    ...
    default_digital_twin_style = {
        'display': 'none', 'width': '100%', 'height': '98vh',
        'padding': '0.5rem', 'overflow-y': 'auto'
    }
    default_side_by_side_style = {
        'display': 'none', 'flex-direction': 'row', 'width': '66.66vw', 'min-width': '66.66vw',
        'max-width': '66.66vw', 'height': '98vh', 'margin': '0', 'padding': '0', 'gap': '0.2rem'
    }
    default_map_table_style = {
        'display': 'flex', 'flex-direction': 'column', 'width': '33.33vw', 'min-width': '33.33vw',
        'max-width': '33.33vw', 'height': '98vh', 'margin': '0', 'padding': '0', 'gap': '0.2rem'
    }
    ...
    clicked_map_style = {
        'width': '100%', 'min-width': '100%', 'max-width': '100%', 'height': '46.5vh',
        'padding': '0.5rem', 'background-color': '#1a1a1a', 'border': '2px solid #444',
        'border-radius': '8px', 'margin': '0.2rem 0', 'position': 'relative',
    ...
    visible_plot_style = {
        'display': 'block', 'width': '100%', 'height': '49vh',
        'padding': '0.5rem', 'background-color': '#1a1a1a', 'border': '2px solid #444',
        'border-radius': '8px', 'margin': '0.2rem 0', 'overflow-y': 'auto'
    }
    visible_satellite_style = {
        'display': 'block', 'width': '100%', 'height': '35vh', 'overflow': 'auto',
        'box-sizing': 'border-box', 'background-color': '#1a1a1a', 'border': '2px solid #444',
        'border-radius': '8px', 'margin': '0.2rem'
    }
    ...
    visible_side_by_side_style = {
        'display': 'flex', 'flex-direction': 'row', 'width': '66.66vw', 'min-width': '66.66vw',
        'max-width': '66.66vw', 'height': '98vh', 'margin': '0', 'padding': '0', 'gap': '0.07rem'
    }
    visible_map_table_style = {
        'display': 'flex', 'flex-direction': 'column', 'width': '35vw', 'min-width': '35vw',
        'max-width': '35vw', 'height': '98vh', 'margin': '0', 'padding': '0', 'gap': '0.2rem'
    }
    visible_cards_satellite_style = {
        'display': 'flex', 'flex-direction': 'row', 'width': '100%', 'height': '32vh',
        'gap': '0.2rem'
    }
